  ...
  return (
    <div className="container">
      <div className="line-1">
        <h1>Hey, This is Manohar</h1>
      </div>
      <h2 className="line-2">
        Welcome to my digital playground, where I transform caffeine into code,
        bugs into features.
      </h2>
      <h2 className="line-3">
        I'm not just a software developer; I'm a problem-solving sorcerer with a
        keyboard.
      </h2>
      <h3 className="line-4">I love Quirky jokes and Qwerty jobs</h3>
      <h3 className="scroll">Scroll down to know more about me</h3>
      <svg
